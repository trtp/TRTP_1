...
# 使用示例
txt_folder = "/home/ubuntu/Desktop/dataset/droidCutImagePromptTest/Llama-3.2-11B-Vision-Instruct"  # 替换为 TXT 文件夹路径
video_folder = "/home/ubuntu/Desktop/dataset/droid"  # 替换为视频文件夹路径
output_file = "/home/ubuntu/Desktop/dataset/droidJsonDatsetTest/Llama-3.2-11B-prompt-output_dataset.json"  # 替换为输出数据集路径
