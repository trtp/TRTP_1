...
# 使用示例
txt_folder = "/home/ubuntu/Desktop/dataset/droidCutImagePromptTest/Ovis1.6-Gemma2-9B"  # 替换为 TXT 文件夹路径
video_folder = "/home/ubuntu/Desktop/dataset/droid"  # 替换为视频文件夹路径
output_file = "/home/ubuntu/Desktop/dataset/droidJsonDatsetTest/Ovis1.6-Gemma2-9B_prompt_output_dataset.json"  # 替换为输出数据集路径
